...
This repository documents an AI experiment in theoretical physics research. The Codex App with GPT-5.4 at Extra High reasoning effort was used to investigate whether the `Æther-flow` interpretation of relativity, a concept formulated by Alaxander Ricciardi, could be developed into a viable interpretation of relativity and expanded into a structured research line.
...
<img width="30" height="30" align="center" src="https://github.com/user-attachments/assets/a8e0ea66-5d8f-43b3-8fff-2c3d74d57f53"> GitHub (Omega.py)
